export const SUB_AREAS: Record<string, {
  ...
  "kafd": {
    ...
    tldr: "A chauffeur in KAFD, Riyadh is quoted on WhatsApp before booking and available 24/7, built for corporate accounts and executive travel. It is about 30 minutes from King Khalid International Airport (RUH), with monthly billing available for companies.",
    tldrFacts: [{ label: "To RUH", value: "~30 min" }, { label: "Pricing", value: "Quoted on WhatsApp / Corporate" }, { label: "Hours", value: "24/7" }, { label: "Fleet", value: "Executive sedan/SUV" }],
    faqs: [
      { question: "Do you offer corporate accounts for companies in KAFD?", answer: "Yes. We set up monthly-billed corporate accounts for banks, funds, and firms based in KAFD, with dedicated executive drivers and rides." },
  ...
  "olaya": {
    ...
    description: "Reliable taxi and executive transport in Olaya, Riyadh's central business and hotel district.",
    ...
    tldr: "A taxi in Olaya, Riyadh's commercial heart, is quoted on WhatsApp before booking and available 24/7. Olaya is about 30 minutes from King Khalid International Airport (RUH), close to Kingdom Centre and Al Faisaliah Tower.",
    tldrFacts: [{ label: "To RUH", value: "~30 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }, { label: "Popular for", value: "Business hotels" }],
    faqs: [
      { question: "How far is Olaya from Riyadh airport?", answer: "Olaya is about 30 minutes from King Khalid International Airport (RUH), with meet & greet transfers." },
      ...
      { question: "Can I book an executive car for Olaya business meetings?", answer: "Yes, executive sedans and SUVs are available on request, quoted on WhatsApp, or hourly hire for business travel around Olaya." },
    ],
  },
  "diplomatic-quarter": {
    ...
    tldr: "A chauffeur in the Diplomatic Quarter (DQ), Riyadh is quoted on WhatsApp, discreet, and available 24/7 — suited to embassy and delegation travel. It is about 35 minutes from King Khalid International Airport (RUH).",
    tldrFacts: [{ label: "To RUH", value: "~35 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }, { label: "Fleet", value: "Luxury sedan/SUV" }],
    faqs: [
      ...
      { question: "How far is the Diplomatic Quarter from Riyadh airport?", answer: "The Diplomatic Quarter is about 35 minutes from King Khalid International Airport (RUH), with executive transfers." },
  ...
  "al-balad": {
    ...
    description: "Book a taxi in Al Balad, the UNESCO-listed historic heart of Jeddah, with door-to-door pickup from the old souks and coral-stone houses.",
    ...
    tldr: "A taxi in Al Balad, historic Jeddah, is quoted on WhatsApp before booking and available 24/7. It is about 30 minutes to King Abdulaziz Airport (JED) and roughly 1 hour to Makkah, with door-to-door pickup from the old town.",
    tldrFacts: [{ label: "To JED", value: "~30 min" }, { label: "To Makkah", value: "~1 hr" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Al Balad from Jeddah airport?", answer: "Al Balad is about 30 minutes from King Abdulaziz International Airport (JED) by taxi, depending on traffic. We arrange meet & greet transfers, quoted on WhatsApp, both ways." },
  ...
  "corniche": {
    ...
    description: "Scenic rides and quick pickups, quoted on WhatsApp, along the Jeddah Corniche and waterfront, from King Fahd's Fountain to the Floating Mosque.",
    ...
    tldr: "A taxi along the Jeddah Corniche is quoted on WhatsApp before booking and available 24/7. The waterfront is about 25 minutes from King Abdulaziz Airport (JED) and roughly 1 hour 10 minutes to Makkah.",
    tldrFacts: [{ label: "To JED", value: "~25 min" }, { label: "To Makkah", value: "~1 hr 10 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      ...
      { question: "Can you pick up along the Corniche at night?", answer: "Yes, we operate 24/7 with quick pickups and a clear price on WhatsApp anywhere along the Jeddah Corniche and waterfront." },
  ...
  "al-hamra": {
    ...
    description: "Taxi service in Al Hamra, Jeddah — close to King Fahd's Fountain, the consulates district, and waterfront hotels.",
    ...
    tldr: "A taxi in Al Hamra, Jeddah is quoted on WhatsApp before booking and available 24/7. The district is about 25 minutes from King Abdulaziz Airport (JED) and roughly 1 hour to Makkah.",
    tldrFacts: [{ label: "To JED", value: "~25 min" }, { label: "To Makkah", value: "~1 hr" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Al Hamra from Jeddah airport?", answer: "Al Hamra is about 25 minutes from King Abdulaziz International Airport (JED) by taxi. We arrange transfers with meet & greet, quoted on WhatsApp, on arrival." },
  ...
  "obhur": {
    ...
    description: "Transfers to and from the beach resorts of Obhur (Abhur North & South), north Jeddah, quoted on WhatsApp, available 24/7.",
    ...
    tldr: "A taxi to or from Obhur (Abhur), north Jeddah's resort area, is quoted on WhatsApp before booking and available 24/7. It is about 30–40 minutes to King Abdulaziz Airport (JED) and roughly 1 hour 20 minutes to Makkah.",
    tldrFacts: [{ label: "To JED", value: "~30–40 min" }, { label: "To Makkah", value: "~1 hr 20 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Obhur from Jeddah airport?", answer: "Obhur (Abhur) is about 30–40 minutes from King Abdulaziz International Airport (JED), depending on whether you need North or South Obhur. We offer resort transfers." },
      ...
      { question: "Is Obhur far from Makkah by taxi?", answer: "Obhur to Makkah is about a 1 hour 20 minute drive. We arrange comfortable transfers, quoted on WhatsApp, with luggage space for families." },
    ],
  },
  "al-safaa": {
    city: "jeddah", subarea: "al-safaa", name: "Al Safaa", nameAr: "الصفا",
    description: "Fast, 24/7 taxi dispatch in the Al Safaa district of Jeddah for local rides, airport transfers, and Makkah trips.",
    ...
    tldr: "A taxi in Al Safaa, Jeddah is quoted on WhatsApp before booking and available 24/7. The district is about 20 minutes from King Abdulaziz Airport (JED) and roughly 1 hour to Makkah.",
    tldrFacts: [{ label: "To JED", value: "~20 min" }, { label: "To Makkah", value: "~1 hr" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Al Safaa from Jeddah airport?", answer: "Al Safaa is about 20 minutes from King Abdulaziz International Airport (JED) by taxi, with transfers both ways." },
      ...
      { question: "Can I book Al Safaa to Makkah in advance?", answer: "Yes. Al Safaa to Makkah is about a 1-hour drive; pre-booking secures your vehicle and a Miqat stop for Ihram on request." },
    ],
  },
  "al-rawdah": {
    city: "jeddah", subarea: "al-rawdah", name: "Al Rawdah", nameAr: "الروضة",
    description: "Premium taxi pickups in the upscale Al Rawdah neighbourhood of Jeddah, near malls, clinics, and business offices.",
    ...
    tldr: "A taxi in Al Rawdah, Jeddah is quoted on WhatsApp before booking and available 24/7. This upscale district is about 25 minutes from King Abdulaziz Airport (JED) and roughly 1 hour to Makkah.",
    tldrFacts: [{ label: "To JED", value: "~25 min" }, { label: "To Makkah", value: "~1 hr" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Al Rawdah from Jeddah airport?", answer: "Al Rawdah is about 25 minutes from King Abdulaziz International Airport (JED) by taxi, with meet & greet transfers." },
  ...
  "al-shati": {
    ...
    description: "Taxi service in Al Shati, north Jeddah's seafront district, near the northern Corniche and waterfront hotels.",
    ...
    tldr: "A taxi in Al Shati, north Jeddah is quoted on WhatsApp before booking and available 24/7. The seafront district is about 25 minutes from King Abdulaziz Airport (JED) and roughly 1 hour 10 minutes to Makkah.",
    tldrFacts: [{ label: "To JED", value: "~25 min" }, { label: "To Makkah", value: "~1 hr 10 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Al Shati from Jeddah airport?", answer: "Al Shati is about 25 minutes from King Abdulaziz International Airport (JED) by taxi, with transfers both ways." },
  ...
  "al-salamah": {
    ...
    description: "Reliable taxi pickups in Al Salamah, a central Jeddah district near malls and the Corniche.",
    ...
    tldr: "A taxi in Al Salamah, Jeddah is quoted on WhatsApp before booking and available 24/7. The district is about 20 minutes from King Abdulaziz Airport (JED) and roughly 1 hour to Makkah.",
    tldrFacts: [{ label: "To JED", value: "~20 min" }, { label: "To Makkah", value: "~1 hr" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Al Salamah from Jeddah airport?", answer: "Al Salamah is about 20 minutes from King Abdulaziz International Airport (JED) by taxi, with transfers." },
  ...
  "al-aziziyah-jeddah": {
    ...
    description: "Taxi service in Al Aziziyah, east Jeddah — convenient access to the Makkah Expressway for fast pilgrim transfers.",
    ...
    tldr: "A taxi in Al Aziziyah, east Jeddah is quoted on WhatsApp before booking and available 24/7. With quick access to the Makkah Expressway, it is about 55 minutes to Makkah and 25 minutes to King Abdulaziz Airport (JED).",
    tldrFacts: [{ label: "To JED", value: "~25 min" }, { label: "To Makkah", value: "~55 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      ...
      { question: "How far is Al Aziziyah from Jeddah airport?", answer: "Al Aziziyah is about 25 minutes from King Abdulaziz International Airport (JED) by taxi, with transfers." },
  ...
  "al-faisaliyah": {
    ...
    description: "Taxi pickups in Al Faisaliyah, central Jeddah, for local rides, airport transfers, and Makkah trips.",
    airportMin: "~25 min", makkahMin: "~1 hr", popularFor: "Residential, local rides",
    landmarks: ["Al Faisaliyah district", "Falasteen Street"],
    tldr: "A taxi in Al Faisaliyah, central Jeddah is quoted on WhatsApp before booking and available 24/7. The district is about 25 minutes from King Abdulaziz Airport (JED) and roughly 1 hour to Makkah.",
    tldrFacts: [{ label: "To JED", value: "~25 min" }, { label: "To Makkah", value: "~1 hr" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Al Faisaliyah from Jeddah airport?", answer: "Al Faisaliyah is about 25 minutes from King Abdulaziz International Airport (JED) by taxi, with transfers both ways." },
  ...
  "al-andalus": {
    ...
    description: "Taxi service in Al Andalus, central Jeddah, near malls and main roads for fast local and airport rides.",
    ...
    tldr: "A taxi in Al Andalus, central Jeddah is quoted on WhatsApp before booking and available 24/7. The district is about 20 minutes from King Abdulaziz Airport (JED) and roughly 1 hour to Makkah.",
    tldrFacts: [{ label: "To JED", value: "~20 min" }, { label: "To Makkah", value: "~1 hr" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Al Andalus from Jeddah airport?", answer: "Al Andalus is about 20 minutes from King Abdulaziz International Airport (JED) by taxi, with transfers." },
  ...
  "city-tour": {
    ...
    tldr: "A private Jeddah city tour by car covers Al-Balad old town, the Corniche, King Fahd's Fountain, and the Floating Mosque. Half-day and full-day options are available with a private driver and flexible stops.",
    tldrFacts: [{ label: "Half day", value: "~4 hours" }, { label: "Full day", value: "~8 hours" }, { label: "Vehicle", value: "Private car/SUV" }, { label: "Pricing", value: "Quoted on WhatsApp" }],
    faqs: [
      ...
      { question: "How long is a Jeddah city tour?", answer: "We offer half-day tours (about 4 hours) and full-day tours (about 8 hours) by private car or SUV, at a agreed before you book." },
  ...
  "aziziyah": {
    ...
    description: "Dedicated Umrah and Hajj taxi transfers from Aziziyah hotels to Masjid al-Haram, plus return trips to Jeddah Airport — and 24/7.",
    ...
    tldr: "A taxi in Aziziyah, Makkah is quoted on WhatsApp before booking and available 24/7. The district is about a 10-minute drive to Masjid al-Haram and roughly 50 minutes to Jeddah Airport (JED).",
    tldrFacts: [{ label: "To Haram", value: "~10 min" }, { label: "To JED", value: "~50 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Aziziyah from the Haram?", answer: "Aziziyah is about a 10-minute drive from Masjid al-Haram. We offer transfers to the closest permitted drop-off, with prayer-time road closures handled by the driver." },
  ...
  "ajyad": {
    ...
    description: "Immediate taxi availability in Ajyad, directly adjacent to Masjid al-Haram — ideal for hotel transfers and airport departures.",
    ...
    tldr: "A taxi in Ajyad, Makkah is quoted on WhatsApp before booking and available 24/7. Ajyad sits beside Masjid al-Haram (about a 5-minute walk) and is roughly 1 hour from Jeddah Airport (JED).",
    tldrFacts: [{ label: "To Haram", value: "~5 min walk" }, { label: "To JED", value: "~1 hr" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      ...
      { question: "How much is a taxi from Ajyad to Jeddah airport?", answer: "Ajyad to King Abdulaziz International Airport (JED) is about 1 hour — fare confirmed on WhatsApp before booking. Pre-book with buffer time before your flight." },
  ...
  "al-awali-makkah": {
    ...
    description: "Comfortable rides and Jeddah Airport transfers from Al Awali, southern Makkah, with quick access to the expressway.",
    ...
    tldr: "A taxi in Al Awali, Makkah is quoted on WhatsApp before booking and available 24/7. The district is about a 15-minute drive to Masjid al-Haram and roughly 55 minutes to Jeddah Airport (JED).",
    tldrFacts: [{ label: "To Haram", value: "~15 min" }, { label: "To JED", value: "~55 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Al Awali from the Haram?", answer: "Al Awali is about a 15-minute drive from Masjid al-Haram, with transfers to the nearest permitted drop-off." },
      { question: "Can you collect from Al Awali for Jeddah airport?", answer: "Yes. Al Awali to King Abdulaziz International Airport (JED) is about 55 minutes; pre-book your departure and get a clear price on WhatsApp." },
  ...
  "al-shubaikah": {
    ...
    tldr: "A taxi in Al Shubaikah, Makkah is quoted on WhatsApp before booking and available 24/7. The district is a short 5–10 minute walk from Masjid al-Haram and about 1 hour from Jeddah Airport (JED).",
    tldrFacts: [{ label: "To Haram", value: "~5–10 min walk" }, { label: "To JED", value: "~1 hr" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      ...
      { question: "How much is Al Shubaikah to Jeddah airport?", answer: "Al Shubaikah to King Abdulaziz International Airport (JED) is about 1 hour — fare confirmed on WhatsApp before booking, available 24/7." },
      { question: "Do you serve Al Shubaikah for hotel transfers?", answer: "Yes, we provide pickups for pilgrims staying in Al Shubaikah and the surrounding Haram-area hotels." },
    ],
  },
  "al-mansour": {
    city: "makkah", subarea: "al-mansour", name: "Al Mansour", nameAr: "المنصور",
    description: "Reliable private transfer rides in the Al Mansour district of Makkah for Haram transfers and airport departures.",
    ...
    tldrFacts: [{ label: "To Haram", value: "~10 min" }, { label: "To JED", value: "~55 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Al Mansour from the Haram?", answer: "Al Mansour is about a 10-minute drive from Masjid al-Haram, with transfers to the closest permitted drop-off." },
      { question: "Can you take us from Al Mansour to Jeddah airport?", answer: "Yes. Al Mansour to King Abdulaziz International Airport (JED) is about 55 minutes; pre-book for a and buffer time." },
  ...
  "al-markazia": {
    ...
    description: "Taxi and Ziyarat tours starting directly from Al Markazia (Central Area) hotels beside Masjid an-Nabawi.",
    ...
    tldr: "A taxi in Al Markazia, the Central Area of Madinah, is quoted on WhatsApp before booking and available 24/7. It sits beside Masjid an-Nabawi (a short walk) and is about 25 minutes from Prince Mohammad Airport (MED).",
    tldrFacts: [{ label: "To Nabawi", value: "~5 min walk" }, { label: "To MED", value: "~25 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      ...
      { question: "How far is Al Markazia from Madinah airport?", answer: "Al Markazia is about 25 minutes from Prince Mohammad Bin Abdulaziz Airport (MED), with meet & greet transfers." },
  ...
  "qaba": {
    ...
    description: "Transport to and from Quba Mosque and the surrounding district of Madinah — the first mosque built in Islam.",
    ...
    tldr: "A taxi in the Quba district of Madinah is quoted on WhatsApp before booking and available 24/7. Quba Mosque is about 4 km from Masjid an-Nabawi, and the airport (MED) is roughly 25 minutes away.",
    tldrFacts: [{ label: "Quba → Nabawi", value: "~4 km" }, { label: "To MED", value: "~25 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Quba Mosque from Masjid an-Nabawi?", answer: "Quba Mosque is about 4 km from Masjid an-Nabawi — a short taxi ride, and a popular Ziyarat stop." },
  ...
  "uhud": {
    ...
    description: "Ziyarat tours and taxi service to the historic Mount Uhud, site of the Battle of Uhud, north of Masjid an-Nabawi.",
    ...
    tldr: "A taxi to the Mount Uhud district of Madinah is quoted on WhatsApp before booking and available 24/7. Mount Uhud is about 6 km from Masjid an-Nabawi and roughly 20 minutes from the airport (MED).",
    tldrFacts: [{ label: "Uhud → Nabawi", value: "~6 km" }, { label: "To MED", value: "~20 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Mount Uhud from Masjid an-Nabawi?", answer: "Mount Uhud is about 6 km north of Masjid an-Nabawi — a short taxi ride and a key Ziyarat site." },
      ...
      { question: "Is taxi available to Mount Uhud at any time?", answer: "Yes, we provide 24/7 transport to and from the Mount Uhud district." },
    ],
  },
  "al-awali-madinah": {
    city: "madinah", subarea: "al-awali-madinah", name: "Al Awali", nameAr: "العوالي",
    description: "Airport transfers and local rides in Al Awali, southern Madinah, near Quba and the Makkah road.",
    ...
    tldr: "A taxi in Al Awali, southern Madinah, is quoted on WhatsApp before booking and available 24/7. The district is about 8 km from Masjid an-Nabawi and roughly 30 minutes from the airport (MED).",
    tldrFacts: [{ label: "To Nabawi", value: "~8 km" }, { label: "To MED", value: "~30 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Al Awali from Masjid an-Nabawi?", answer: "Al Awali is about 8 km from Masjid an-Nabawi — a short taxi ride, close to Quba Mosque." },
      { question: "Can you collect from Al Awali for the airport?", answer: "Yes. Al Awali to Prince Mohammad Bin Abdulaziz Airport (MED) is about 30 minutes, with pickup from your door." },
  ...
  "al-aqiq-madinah": {
    ...
    description: "Taxi service in Al Aqiq, an upscale western district of Madinah near the Knowledge Economic City and main highways.",
    ...
    tldr: "A taxi in Al Aqiq, western Madinah, is quoted on WhatsApp before booking and available 24/7. The district is about 6 km from Masjid an-Nabawi and roughly 25 minutes from the airport (MED).",
    tldrFacts: [{ label: "To Nabawi", value: "~6 km" }, { label: "To MED", value: "~25 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Al Aqiq from Masjid an-Nabawi?", answer: "Al Aqiq is about 6 km from Masjid an-Nabawi — a short taxi ride from this upscale western district." },
      { question: "Do you serve Al Aqiq for airport transfers?", answer: "Yes. Al Aqiq to Prince Mohammad Bin Abdulaziz Airport (MED) is about 25 minutes, with door-to-door pickup." },
  ...
  "sultanah": {
    ...
    description: "Reliable taxi rides in the central Sultanah district of Madinah, close to Masjid an-Nabawi and main shopping streets.",
    ...
    tldr: "A taxi in Sultanah, central Madinah, is quoted on WhatsApp before booking and available 24/7. The district is about 3 km from Masjid an-Nabawi and roughly 20 minutes from the airport (MED).",
    tldrFacts: [{ label: "To Nabawi", value: "~3 km" }, { label: "To MED", value: "~20 min" }, { label: "Pricing", value: "Quoted on WhatsApp" }, { label: "Hours", value: "24/7" }],
    faqs: [
      { question: "How far is Sultanah from Masjid an-Nabawi?", answer: "Sultanah is about 3 km from Masjid an-Nabawi — a quick taxi ride from this central Madinah district." },
      ...
      { question: "How far is Sultanah from Madinah airport?", answer: "Sultanah to Prince Mohammad Bin Abdulaziz Airport (MED) is about 20 minutes, with door-to-door pickup." },
    ],
  },
  ...
  "dhahran": {
    ...
    tldr: "A chauffeur in Dhahran is quoted on WhatsApp before booking and available 24/7, built for corporate and Aramco-related travel. It is about 25 minutes from King Fahd International Airport (DMM), with monthly billing available for companies.",
    tldrFacts: [{ label: "To DMM", value: "~25 min" }, { label: "Pricing", value: "Quoted on WhatsApp / Corporate" }, { label: "Hours", value: "24/7" }, { label: "Popular for", value: "Aramco, KFUPM" }],
    faqs: [
      ...
      { question: "How far is Dhahran from Dammam airport?", answer: "Dhahran is about 25 minutes from King Fahd International Airport (DMM), with meet & greet transfers." },
