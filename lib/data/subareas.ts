export const SUB_AREAS: Record<string, {
  ...
  "ajyad": {
    ...
    faqs: [
      ...
      { question: "How much is a taxi from Ajyad to Jeddah airport?", answer: "Ajyad to King Abdulaziz International Airport (JED) is about 1 hour, from SAR 249. Pre-book with buffer time before your flight." },
  ...
  "al-shubaikah": {
    ...
    faqs: [
      ...
      { question: "How much is Al Shubaikah to Jeddah airport?", answer: "Al Shubaikah to King Abdulaziz International Airport (JED) is about 1 hour, from SAR 249, available 24/7." },
