        ...
        <AnimatePresence mode="wait">
          {!booking ? (
            ...
            >
              ...
              <div className="rounded-3xl border border-[#16A34A]/12 bg-white p-8 shadow-[0_12px_40px_rgba(0,0,0,0.08)] relative overflow-hidden">
                ...
                <form onSubmit={handleTrackSubmit} className="space-y-5">
                  ...
                  <div className="flex items-start gap-2 text-[0.6rem] text-[#6B7280] pt-2 border-t border-[#C9A84C]/10">
            ...
            >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full border border-[#16A34A]/15 bg-white px-4.5 py-2 text-xs font-medium text-[#C9A84C] hover:bg-[#C9A84C]/10 transition-all"
              >
              ...
              {/* Status Header */}
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-3xl border border-[#16A34A]/12 bg-white">
              ...
              <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
                ...
                <div className="space-y-8">
                        ...
                        {timelineSteps.map((step, idx) => {
                          ...
                          return (
                            <div key={idx} className="relative">
                              ...
                              <div className="space-y-1">
                                <h4 className={`text-sm font-bold transition-colors ${isActive ? "text-[#1C1C1C]" : "text-[#6B7280]/40"}`}>
                                ...
                                <p className={`text-xs ${isActive ? "text-[#6B7280]" : "text-[#6B7280]/30"}`}>
                  ...
                  <div className="rounded-3xl border border-[#C9A84C]/10 bg-white overflow-hidden shadow-xl">
                    ...
                    <div className="relative h-72 w-full bg-[#F0FDF4] flex items-center justify-center p-6 overflow-hidden">
                      ...
                      <svg className="w-full h-full max-w-sm" viewBox="0 0 400 200">
                        ...
                        {booking.status === "IN_PROGRESS" && (
                          ...
                          >
                            <circle cx="200" cy="65" r="14" fill="#C9A84C" className="shadow-[0_0_15px_rgba(22,163,74,0.8)]" />
                      ...
                      {/* Map info tag */}
                      <div className="absolute bottom-4 left-4 right-4 bg-white/90 border border-[#16A34A]/15 rounded-xl p-3 flex justify-between text-[0.6rem] backdrop-blur-md">
                        <div>
                          <p className="text-[#6B7280] font-bold">PICKUP POINT</p>
                          <p className="text-[#1C1C1C] truncate max-w-[180px]">{booking.pickupLocation}</p>
                        </div>
                        <div className="text-right border-l border-[#C9A84C]/10 pl-4">
                          <p className="text-[#6B7280] font-bold">DESTINATION</p>
                          <p className="text-[#1C1C1C] truncate max-w-[180px]">{booking.dropoffLocation}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-8">
                  ...
                  {booking.status === "DRIVER_ASSIGNED" || booking.status === "IN_PROGRESS" || booking.status === "COMPLETED" ? (
                    <div className="rounded-3xl border border-[#16A34A]/12 bg-white p-6 shadow-xl relative overflow-hidden">
                    ...
                    booking.status !== "CANCELLED" && (
                      <div className="rounded-3xl border border-[#C9A84C]/10 bg-white p-6 text-center space-y-4">
