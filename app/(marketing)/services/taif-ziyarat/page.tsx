...
const DESCRIPTION = "Book a private Taif Ziyarat tour from Makkah or Jeddah — Masjid Abdullah Ibn Abbas, Wadi Mitna, Al-Hada cable car, and rose factories with professional drivers.";
