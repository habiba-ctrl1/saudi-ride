...
const TITLE = "Intercity & Long Distance Taxi Service Saudi Arabia | Cross-Country & GCC";
const DESCRIPTION = "Book private long-distance intercity transfers in Saudi Arabia. Fixed-price rides between Riyadh, Jeddah, Makkah, Madinah, Dammam, and cross-border GCC transfers.";
...
const ROUTES = [
  { name: "Riyadh to Dammam / Al Khobar", dist: "410 km (~3.5 hrs)", price: "From SAR 750", desc: "Express highway transfer connecting Saudi capital with Eastern Province business hubs." },
  ...
  { name: "Jeddah to Madinah", dist: "420 km (~4 hrs)", price: "From SAR 450", desc: "Direct highway transfer from Jeddah Airport or hotel straight to Madinah Markaziyah." },
  { name: "Riyadh to Jeddah / Makkah", dist: "950 km (~9 hrs)", price: "From SAR 1,800", desc: "Cross-kingdom journey in executive SUV (GMC Yukon) or sedan." },
  { name: "Dammam to Bahrain (Causeway)", dist: "60 km (~1 hr)", price: "From SAR 250", desc: "Cross-border transfer over King Fahd Causeway to Manama." },
  { name: "Dammam to Qatar (Salwa Border)", dist: "300 km (~3 hrs)", price: "From SAR 1,200", desc: "GCC inter-state transfer connecting Saudi Eastern Province with Doha." },
];
