  ...
  try {
    ...
    if (resend) {
      const { data, error } = await resend.emails.send({
        from: "Taxi Saudi Arabia Driver Network <onboarding@resend.dev>",
        to: [adminEmail],
        ...
        html: `
          <div style="font-family: sans-serif; padding: 20px; color: #111; max-width: 600px; border: 1px solid #C9A84C; border-radius: 12px;">
            <h2 style="color: #C9A84C; border-bottom: 1px solid #eee; padding-bottom: 10px;">Taxi Saudi Arabia Chauffeur Operations</h2>
