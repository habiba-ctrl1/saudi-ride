...
const AR_UMRAH: Record<string, { heading: string; intro: string; waPrefill: string; emailSubject: string; emailBody: string }> = {
  ...
  "jeddah-airport-to-makkah": {
    heading: "وصول للعمرة كعائلة أو مجموعة؟",
    intro:
      "للعائلات والمجموعات نوفّر سيارة دفع رباعي كبيرة أو فان ليسافر الجميع معاً مع الأمتعة — سيارة واحدة وسائق واحد من مطار جدة إلى مكة المكرمة. استقبال في صالة الوصول بلوحة اسم، ومتابعة للرحلة الجوية، وتوقف عند الميقات لارتداء الإحرام عند الطلب.",
    waPrefill: `السلام عليكم، نقل عمرة — من مطار جدة إلى مكة المكرمة.\n• رقم الرحلة ووقت الوصول: \n• عدد الركاب (كبار / أطفال): \n• الأمتعة: \n• نوع السيارة (سيدان / SUV / فان): \n• توقف عند الميقات للإحرام؟: `,
    emailSubject: "طلب عرض سعر لنقل مجموعة عمرة — من مطار جدة إلى مكة",
    emailBody: `مرحباً فريق تاكسي السعودية،\n\nنرغب بعرض سعر مكتوب لنقل معتمرين من مطار جدة إلى مكة المكرمة.\n\n• اسم الوكالة / المجموعة: \n• اسم جهة الاتصال: \n• تاريخ الوصول ورقم الرحلة: \n• عدد المعتمرين (كبار / أطفال): \n• الأمتعة: \n• السيارات المطلوبة (SUV / فان): \n• توقف عند الميقات للإحرام؟: \n\nيرجى تأكيد سعر ثابت قبل الحجز.\n\nشكراً لكم.`,
  },
  "riyadh-to-makkah": {
    heading: "مجموعة عمرة من الرياض إلى مكة؟",
    intro:
      "للعائلات ومجموعات العمرة نوفّر سيارة دفع رباعي كبيرة أو فان ليسافر الجميع معاً مع الأمتعة على الطريق الطويل من الرياض — سيارة واحدة وسائق واحد، مع توقف عند ميقات قرن المنازل للقادمين من نجد وتوقفات للصلاة والراحة.",
    waPrefill: `السلام عليكم، نقل عمرة — من الرياض إلى مكة المكرمة.\n• التاريخ والوقت: \n• عدد الركاب (كبار / أطفال): \n• الأمتعة: \n• نوع السيارة (سيدان / SUV / فان): \n• توقف عند الميقات للإحرام؟: `,
    emailSubject: "طلب عرض سعر لنقل مجموعة عمرة — من الرياض إلى مكة",
    emailBody: `مرحباً فريق تاكسي السعودية،\n\nنرغب بعرض سعر مكتوب لنقل معتمرين من الرياض إلى مكة المكرمة.\n\n• اسم الوكالة / المجموعة: \n• اسم جهة الاتصال: \n• تاريخ الرحلة: \n• عدد المعتمرين (كبار / أطفال): \n• الأمتعة: \n• السيارات المطلوبة (SUV / فان): \n• توقف عند الميقات للإحرام؟: \n\nيرجى تأكيد سعر ثابت قبل الحجز.\n\nشكراً لكم.`,
  },
};
...
export function ArabicRoutePage({ content }: { content: ArabicRouteContent }) {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-[#FAFAF7] text-[#1C1C1C] pb-24" lang="ar">
      ...
      {["riyadh-to-dammam", "madinah-to-alula", "jeddah-to-kaec", "jeddah-airport-to-swissotel-makkah", "dammam-to-doha", "riyadh-to-dubai", "jeddah-to-madinah", "makkah-to-madinah", "jeddah-airport-to-makkah", "riyadh-to-makkah"].includes(content.slug) && (
