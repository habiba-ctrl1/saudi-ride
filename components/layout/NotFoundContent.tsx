...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#FAFAF7] text-[#1C1C1C] flex flex-col justify-center items-center px-6 relative overflow-hidden">
      ...
      <div className="text-center max-w-xl relative z-10 space-y-8">
        ...
        <div className="flex justify-center">
          <div className="relative flex h-24 w-24 items-center justify-center rounded-full border border-[#C9A84C]/30 bg-white shadow-[0_0_30px_rgba(22,163,74,0.15)] animate-pulse">
        ...
        <div className="space-y-3">
          ...
          <h1 className="font-heading text-4xl font-bold md:text-5xl tracking-tight text-[#1C1C1C]">
            Lost in Transit
          </h1>
        ...
        <div className="grid grid-cols-2 gap-4 max-w-md mx-auto pt-4">
          <Link
            href="/book"
            className="flex flex-col items-center justify-center rounded-2xl border border-[#16A34A]/12 bg-[#F0FDF4] p-4 hover:border-[#C9A84C]/45 hover:bg-[#1A1813]/20 transition-all group"
          >
            <MapPin className="h-5 w-5 text-[#C9A84C] mb-2 group-hover:scale-110 transition-transform" />
            <span className="text-[0.65rem] font-bold uppercase tracking-wider text-[#1C1C1C]">Book Transfer</span>
            <span className="text-[0.55rem] text-[#6B7280] mt-0.5">احجز رحلة</span>
          </Link>
          ...
          >
            ...
            <span className="text-[0.65rem] font-bold uppercase tracking-wider text-[#1C1C1C]">Get Help</span>
            <span className="text-[0.55rem] text-[#6B7280] mt-0.5">الدعم الفني</span>
          </Link>
        </div>
